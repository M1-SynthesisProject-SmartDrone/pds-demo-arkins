...
private:
	...
	std::vector<Uniform> uniformPoints;
	Informations infos;
...
public:
	...
	Arkins(std::vector<Coordinates> attractionPoints, std::vector<Coordinates> repulsionPoints,
		std::vector<Tangent> tangentialPoints, std::vector<Uniform> uniformPoints);
	...
	std::vector<Tangent>& getTangentialPoints();
	std::vector<Uniform>& getUniformPoints();
	...
	void uniform(Coordinates& droneCoordinates, Uniform& uniformPoint, Coordinates& goalPoint, Informations &infos);
	void tangent(Coordinates &droneCoordinates, Tangent& tangentPoint, Coordinates &goalPoint, Informations &infos);
...
private:
	...
	void calculate_vector(Coordinates &droneCoordinates, Uniform &uniformCoordinates, Vector &vector);
	void calculate_vector(Tangent &tangentCoordinates, Coordinates &droneCoordinates, Vector &vector);
	...
	bool isInUniformRadius(Coordinates& droneCoordinates, Uniform& uniformPoint);
	bool isInTangentialRadius(Coordinates &droneCoordinates, Tangent &tangentPoint);
	...
	void calculate_dist_between_points(Coordinates& droneCoordinates, Uniform& uniformPoint);
	void calculate_dist_between_points(Coordinates& droneCoordinates, Tangent& tangentPoint);
